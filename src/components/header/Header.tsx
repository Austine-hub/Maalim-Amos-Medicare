        ...
        <div className={styles.logoSection}>
          <Link href="/" className={styles.logoLink} aria-label="Marplewood Pharmacy - Home">
            <div className={styles.logo}>
              <span className={styles.logoText}>MAALIM AMOS </span>
              <span className={styles.logoSubtext}>ISBITAALKA RAYSASHADA DEGDEGGA AH <span className={styles.logoSubtext}>AND </span> 
              CHEMISTS
              </span>
        ...
        <div className={styles.searchSection}>
          <form onSubmit={handleSearch} className={styles.searchForm} role="search">
            <label htmlFor="search-input" className={styles.visuallyHidden}>
              Search everything at ISBITAALKA RAYSASHADA DEGDEGGA AH
            </label>
            <div className={styles.searchWrapper}>
              ...
              <input
                ...
                placeholder="Search everything at Isbitaalka Raysashada Degdegga ah and  Pharmacy..."
                value={searchQuery}
