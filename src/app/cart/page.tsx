...
const WHATSAPP_PHONE = '254112303412'; // Replace with your actual phone number in international format
...
export default function CartPage() {
  ...
  const handleWhatsAppCheckout = useCallback(() => {
    ...
    const message = `Hello MAALIM AMOS :Isbitaalka Raysashada Degdegga ah and Pharmacy,\n\nI would like to place an order:\n\n${itemsList}\n\n*Total: KSh ${subtotal.toLocaleString()}*\n*Items: ${totalItems}*\n\nPlease confirm availability. Thank you.`;
